...
export default function Destinations() {
  const [currentIndex] = useState(0); // setCurrentIndex removed due to unused variable
  const cardsPerView = 4;
  const maxIndex = Math.max(0, destinations.length - cardsPerView); // eslint-disable-line no-unused-vars
